...
import { ItemEntityRequestModel } from 'src/app/features/learning/models/items.models';
...
export class NewComponent {
  ...
  addIt() {
    ...
    if (this.form.valid) {
      const payload: ItemEntityRequestModel = this.form
        .value as ItemEntityRequestModel;
